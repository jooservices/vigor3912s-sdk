/**
 * Shared minimal parsing helper for the `wan` domain's write operations.
 *
 ...
 * text; only `wan status` (the family's one read operation, see
 * `./status.ts`) has enough documented structure to justify a real DTO.
 */
