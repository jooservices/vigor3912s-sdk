/**
 * Shared test support for `tests/domains/srv/*.test.ts` -- the fixed
 ...
 * family's own write scope (`tests/domains/srv/**`). Mirrors
 * `tests/domains/wan/support.ts` exactly.
 */
 ...
 * `TypedOperation` type). Mirrors
 * `tests/domains/sys/test-helpers.ts#dispatchThroughFakeTransport`.
 */
 ...
 * `tests/domains/sys/test-helpers.ts#expectClosedTransportFailure`.
 */
