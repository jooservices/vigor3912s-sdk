/**
 * Shared test support for `tests/domains/log/*.test.ts` -- the fixed
 ...
 * family's own write scope (`tests/domains/log/**`). Mirrors
 * `tests/domains/portmaptime/support.ts`'s precedent for this same problem.
 */
