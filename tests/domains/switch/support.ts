/**
 * Shared test support for `tests/domains/switch/*.test.ts` -- the fixed
 ...
 * family's own write scope (`tests/domains/switch/**`). Mirrors
 * `tests/domains/wan/support.ts`'s precedent verbatim.
 */
