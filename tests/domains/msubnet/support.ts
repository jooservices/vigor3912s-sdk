/**
 * Shared test support for `tests/domains/msubnet/*.test.ts` -- the fixed
 ...
 * family's own write scope (`tests/domains/msubnet/**`).
 *
 * Private copy of `tests/domains/wan/support.ts`'s helpers, not a shared
 * cross-family import -- keeps this family's write scope independent per
 * `BACKLOG.md`'s Wave 4 parallelism proof.
 */
