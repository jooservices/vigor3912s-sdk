/**
 * Shared test support for `tests/domains/qos/*.test.ts` -- the fixed
 ...
 * family's own write scope (`tests/domains/qos/**`). Mirrors `tests/domains/
 * wan/support.ts` / `tests/domains/srv/support.ts`.
 */
