/**
 * Shared test support for `tests/domains/upnp/*.test.ts` -- the fixed
 ...
 * family's own write scope (`tests/domains/upnp/**`). Mirrors
 * `tests/domains/wan/support.ts`'s identical helper set.
 */
